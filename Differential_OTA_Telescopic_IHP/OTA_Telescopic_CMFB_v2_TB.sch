...
N -430 30 -430 50 {lab=GND}
N -430 -90 -430 -30 {lab=VDD}
N 130 -210 130 -100 {lab=VDD}
N -190 0 -190 20 {lab=#net1}
N -190 80 -190 100 {lab=GND}
N -190 -20 -190 0 {lab=#net1}
N -190 -90 -190 -80 {lab=#net2}
N -190 -110 -190 -90 {lab=#net2}
N -20 -100 -20 -60 {lab=#net2}
N -190 -110 -20 -110 {lab=#net2}
N -20 -110 -20 -100 {lab=#net2}
N -190 -20 -20 -20 {lab=#net1}
N 280 -40 340 -40 {lab=Vout}
N 340 -60 340 -40 {lab=Vout}
N 40 20 90 20 {lab=#net3}
N 40 20 40 40 {lab=#net3}
N 40 100 40 120 {lab=GND}
C {isource.sym} 40 70 0 0 {name=I0 value=100u}
C {gnd.sym} 130 40 0 0 {name=l1 lab=GND}
C {vsource.sym} -430 0 0 0 {name=V1 value=1.8 savecurrent=false}
C {gnd.sym} -430 50 0 0 {name=l3 lab=GND}
C {lab_wire.sym} -430 -90 0 0 {name=p1 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 130 -210 0 0 {name=p3 sig_type=std_logic lab=VDD}
C {vsource.sym} -190 -50 0 0 {name=V6 value="0 AC 1" savecurrent=false}
C {vsource.sym} -190 50 0 0 {name=V7 value=0.9 savecurrent=false}
C {gnd.sym} -190 100 0 0 {name=l5 lab=GND}
C {noconn.sym} 340 -60 0 0 {name=l2}
C {devices/code.sym} -580 -250.390625 0 0 {name=TT_MODELS
only_toplevel=true
...
"
spice_ignore=false}
C {code.sym} -450 -250 0 0 {name=AC only_toplevel=true value="
.control
save all
...
C {lab_wire.sym} 330 -40 0 0 {name=p5 sig_type=std_logic lab=Vout}
C {devices/launcher.sym} -510 -330 0 0 {name=h3
...
.endc
"}
C {code.sym} -330 -250 0 0 {name=save only_toplevel=false value="
.op
...
C {OTA_Telescopic_CMFB_v2.sym} 130 -40 0 0 {name=x1}

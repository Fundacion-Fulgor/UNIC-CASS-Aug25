...
C {NAND.sym} 420 -380 0 0 {name=x1}
C {lab_wire.sym} 480 -400 3 0 {name=p17 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 480 -540 0 0 {name=p22 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 590 -470 0 1 {name=p2 sig_type=std_logic lab=AB_N}

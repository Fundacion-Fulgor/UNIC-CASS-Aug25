...
N 80 -128.75 80 -100 { lab=VOUT_D}
N 80 -128.75 486.25 -128.75 {lab=VOUT_D}
N 80 -150 80 -128.75 { lab=VOUT_D}
N 110 40 110 80 {
lab=#net2}
...
C {devices/ipin.sym} 0 -131.25 0 0 {name=p4 lab=VIN_D}
C {devices/opin.sym} 486.25 -128.75 0 0 {name=p5 lab=VOUT_D}

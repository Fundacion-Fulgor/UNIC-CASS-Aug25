...
N 580 -160 642.5 -160 {lab=#net3}
N 760 -160 820 -160 {lab=#net4}
N 340 -160 460 -160 {lab=#net5}
...
C {/foss/designs/DLL/variable_delay.sym} -80 -160 0 0 {name=x1}
C {/foss/designs/DLL/variable_delay.sym} 100 -160 0 0 {name=x2}
C {/foss/designs/DLL/variable_delay.sym} 280 -160 0 0 {name=x3}
C {/foss/designs/DLL/variable_delay.sym} 520 -160 0 0 {name=x4}
C {/foss/designs/DLL/variable_delay.sym} 700 -160 0 0 {name=x5}
C {/foss/designs/DLL/variable_delay.sym} 880 -160 0 0 {name=x6}

...
N 270 90 340 90 {lab=#net1}
N 500 90 530 90 {lab=VOUT}
N 270 370 330 370 {lab=#net1}
N 270 280 330 280 {lab=#net1}
N 270 180 330 180 {lab=#net1}
...
N 270 370 270 470 {lab=#net1}
N 180 470 270 470 {lab=#net1}
N 270 470 330 470 {lab=#net1}
N 410 470 500 470 {lab=VOUT}
N 500 370 500 470 {lab=VOUT}
N 610 90 720 90 {lab=VOUT}
...
C {devices/lab_pin.sym} 705 90 0 1 {name=p8 sig_type=std_logic lab=VOUT}
...
C {sg13g2_stdcells/sg13g2_dlygate4sd3_1.sym} 140 370 0 0 {name=x4 VDD=VCC VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_dlygate4sd3_1.sym} 930 270 0 0 {name=x5 VDD=VCC VSS=VSS prefix=sg13g2_ spice_ignore=true}
C {sg13g2_stdcells/sg13g2_dlygate4sd1_1.sym} 380 90 0 0 {name=x6 VDD=VCC VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_dlygate4sd1_1.sym} 370 180 0 0 {name=x7 VDD=VCC VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_dlygate4sd1_1.sym} 370 280 0 0 {name=x8 VDD=VCC VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_dlygate4sd1_1.sym} 370 370 0 0 {name=x9 VDD=VCC VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_dlygate4sd3_1.sym} 140 470 0 0 {name=x10 VDD=VCC VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_dlygate4sd3_1.sym} 370 470 0 0 {name=x11 VDD=VCC VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_dlygate4sd2_1.sym} 570 90 0 0 {name=x12 VDD=VCC VSS=VSS prefix=sg13g2_ spice_ignore=short}
